...
[task_local]
红包使用情况统计
45 3 1-31/7 * * https://raw.githubusercontent.com/444444/JDJB/main/jd_hbCount.js, tag=红包使用情况统计, enabled=true
================Loon==============
[Script]
cron "45 3 1-31/7 * *" script-path=https://raw.githubusercontent.com/444444/JDJB/main/jd_hbCount.js,tag=红包使用情况统计
===============Surge=================
红包使用情况统计 = type=cron,cronexp="45 3 1-31/7 * *",wake-system=1,timeout=20,script-path=https://raw.githubusercontent.com/444444/JDJB/main/jd_hbCount.js
============小火箭=========
红包使用情况统计 = type=cron,script-path=https://raw.githubusercontent.com/444444/JDJB/main/jd_hbCount.js, cronexpr="45 3 1-31/7 * *", timeout=3600, enable=true
*
*/
